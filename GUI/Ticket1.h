...
#pragma region Windows Form Designer generated code
			...
			void InitializeComponent(void)
			{
				...
				this->label1->Location = System::Drawing::Point(143, -1);
				this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
				this->label1->Name = L"label1";
				this->label1->Size = System::Drawing::Size(271, 48);
				...
				this->label2->Location = System::Drawing::Point(8, 89);
				...
				this->label4->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label4->Location = System::Drawing::Point(8, 57);
				...
				this->label5->Size = System::Drawing::Size(115, 19);
				...
				this->label6->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label6->Location = System::Drawing::Point(367, 148);
				...
				this->label7->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label7->Location = System::Drawing::Point(367, 89);
				...
				this->label8->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label8->Location = System::Drawing::Point(363, 55);
				...
				this->label9->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label9->Location = System::Drawing::Point(367, 120);
				...
				this->label10->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label10->Location = System::Drawing::Point(13, 180);
				...
				this->label11->Font = (gcnew System::Drawing::Font(L"Audrey", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
				this->label11->Location = System::Drawing::Point(336, 180);
				this->label11->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
				this->label11->Name = L"label11";
				this->label11->Size = System::Drawing::Size(114, 19);
				...
				this->label12->Location = System::Drawing::Point(133, 122);
				...
				this->label13->Location = System::Drawing::Point(89, 154);
				...
				this->label14->Location = System::Drawing::Point(77, 186);
				...
				this->label15->Location = System::Drawing::Point(167, 62);
				...
				this->label16->Location = System::Drawing::Point(133, 95);
				...
				this->label17->Location = System::Drawing::Point(425, 60);
				...
				this->label18->Location = System::Drawing::Point(425, 92);
				...
				this->label19->Location = System::Drawing::Point(469, 125);
				...
				this->label20->Location = System::Drawing::Point(421, 154);
				...
				this->label21->Location = System::Drawing::Point(455, 183);
				...
				this->label22->Location = System::Drawing::Point(518, 183);
				...
				this->ClientSize = System::Drawing::Size(599, 239);
...
#pragma endregion
	public:System::Void TicketInfo(DataGridView^ datGridView2, int rowindex)
	{
	...
	private: System::Void Ticket_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		while (bookedflights >> username >> flight_ >> ticket_ >> P_Seat >> P_class) {
			if (flight_ == temp) {
				label15->Text = this->passengerName;
